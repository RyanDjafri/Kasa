...
describe("Given I am connected as an Admin", () => {
  describe("When I am on the Dashboard page, there are bills, and there is one pending", () => {
  ...
  describe("When I am on the Dashboard page, there are bills, and there is one accepted", () => {
  ...
  describe("When I am on the Dashboard page, there are bills, and there are two refused", () => {
  ...
  describe("When I am on the Dashboard page but it is loading", () => {
  ...
  describe("When I am on the Dashboard page but the back-end sends an error message", () => {
  ...
  describe("When I am on the Dashboard page and I click on the arrow", () => {
    test("Then, the tickets list should be unfolding, and cards should appear", async () => {
  ...
  describe("When I am on the Dashboard page and I click on the edit icon of a card", () => {
    test("Then, the right form should be filled", () => {
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname });
      };
  ...
  describe("When I am on the Dashboard page and I click two times on the edit icon of a card", () => {
    test("Then, the big billed icon should appear", () => {
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname });
      };
  ...
  describe("When I am on the Dashboard and there are no bills", () => {
...
describe("Given I am connected as Admin, and I am on the Dashboard page, and I clicked on a pending bill", () => {
  describe("When I click on the accept button", () => {
    test("I should be sent to the Dashboard with a big billed icon instead of the form", () => {
      Object.defineProperty(window, "localStorage", {
        value: localStorageMock,
      });
